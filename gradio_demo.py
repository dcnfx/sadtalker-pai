...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', 
        ...
        print(f"==>> self.sadtalker_paths: {self.sadtalker_paths}")
        ...
        if driven_audio is not None and os.path.isfile(driven_audio):
            ...
            print(f"==>> use_ref_video: {use_ref_video}")
        ...
        t2 = time.time()
        print(f"batch_size = {batch_size} that consume time = {t2-t1}")
        ...
        #     torch.cuda.synchronize()  # wait until all processes are done
