...
class KeypointExtractor():
    def __init__(self, root_path, device='cuda'):
        ...
        model_rootpath = os.path.join(root_path, "gfpgan", "weights")
        self.detector = init_alignment_model('awing_fan',device=device, model_rootpath=model_rootpath)   
        self.det_net = init_detection_model('retinaface_resnet50', half=False,device=device, model_rootpath=model_rootpath)
